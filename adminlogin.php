...
<section class="bg-gray-50 min-h-screen flex items-center justify-center">
  ...
  <div class="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
    ...
    <div class="md:w-1/2 px-8 md:px-16">
      ...
      <form action="adminloginbd.php" method="post" class="flex flex-col gap-4">
        <input class="p-2 mt-8 rounded-xl border" type="text" name="email" placeholder="Email"  required>
        <div class="relative">
      ...
      <div class="mt-3 text-xs flex justify-between items-center text-[#002D74]">
        ...
        <!-- <a href="register.php"class="py-2 px-5 bg-white border rounded-xl hover:scale-110 duration-300">Admin Login</a> -->
      </div>
    </div>
