            ...
            <tbody class="bg-white divide-gray-200">
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td class='px-6 py-4 whitespace-nowrap blue=200 text-blue-500'><a style='text-decoration:none;' href='useredit.php?mno=" . $abc . " &uno=" . $row['mmid'] . "'>Edit</a> &nbsp;&nbsp;<a style='text-decoration:none;' href='.php?mno=" . $abc . " &uno=" . $row['mmid'] . "'>Delete</a> </td>";
                        echo "</tr>";
                    }
                } else {
                    echo "0 results";
